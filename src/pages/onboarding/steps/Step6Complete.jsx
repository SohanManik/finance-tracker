    ...
    <div>
      ...
      <div className="flex flex-col gap-3 mb-8">
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: '#3AAFA9' }}>Primary goal</p>
        ...
        >
          <span className="text-2xl">💼</span>
          <div>
            <p className="text-xs" style={{ color: '#3AAFA9' }}>Employment</p>
            <p className="text-sm font-medium" style={{ color: '#FEFFFF' }}>
        ...
        >
          <span className="text-2xl">💳</span>
          <div>
            <p className="text-xs" style={{ color: '#3AAFA9' }}>Credit cards</p>
            <p className="text-sm font-medium" style={{ color: '#FEFFFF' }}>
        ...
        >
          <span className="text-2xl">🔄</span>
          <div>
            <p className="text-xs" style={{ color: '#3AAFA9' }}>Subscriptions</p>
            <p className="text-sm font-medium" style={{ color: '#FEFFFF' }}>
        ...
        {data.goal_name && (
          ...
          >
            <span className="text-2xl">🎯</span>
            <div>
              <p className="text-xs" style={{ color: '#3AAFA9' }}>Savings goal</p>
              <p className="text-sm font-medium" style={{ color: '#FEFFFF' }}>
                {data.goal_name}
                {data.goal_amount ? ` — $${parseFloat(data.goal_amount).toLocaleString()}` : ''}
              </p>
            </div>
          </div>
        )}
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: '#3AAFA9' }}>Default categories</p>
            <p className="text-sm font-medium" style={{ color: '#FEFFFF' }}>
